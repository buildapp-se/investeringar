...
- **Ränta på ränta (index.html):** inforuta om att det inte är finansiell rådgivning, sedan räknaren (kr/mån, engångsbelopp, år, % per år) och fyra rutor: Du sätter in, Ränta på ränta ger, Du har efter X år, samt länk till "Därför ska du inte handla enskilda aktier" på forskningssidan. Under det tre ingångar (Slippa välja och sköta: fondrobot; Köpa egna fonder; ETF:er och belåning), sedan fondtabellen och fondrobotarna, alltid synliga. Inget "avancerad vy", ingenting att klicka fram (Patrik 2026-09-24: "varför ska den ens vara klickbar"). Därefter länkar (RikaTillsammans, Bogleheads, Småspararguiden, justETF, FI) och kort slutsats och metod.
...
- **ETF och belåning (etf-belaning.html):** en tabell med 17 breda ETF:er grupperade (hela världen, utvecklade, tillväxt, småbolag och faktorer): ticker, avgift, innehav, länder, index, replikering, hemvist, storlek, start. Fonder med inbyggd belåning (Nordnet Global Index 125, Montrose Global Leverage 125). Belåning: fyll i eget kapital och se per plattform lägsta ränta, största lån till den räntan, räntekostnad och hur portföljen ska byggas. Under det räntetrappa och villkor per plattform samt belåningsvärde per värdepapper.
