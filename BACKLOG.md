...
- [ ] **[P1] Slutför verifieringen av kandidaterna.** Åtta punkter står namngivna sist i [kandidater-verifierade.md](docs/research/kandidater-verifierade.md): ISIN för fyra fonder, aktuell KID för DNB Global Indeks S inklusive handelsvaluta, gällande förvaltningsavgift för Storebrand Global All Countries, total årlig avgift för samtliga fem fonder, Amundis faktablad för WEBN i frågan om småbolag ingår, Avanza Globals användning av OTC-derivat, ETF-raderna mot emittentens faktablad, samt köpbarhet och prislista per leverantör. Avanzas och Nordnets fondsidor renderas med JavaScript och kräver manuell kontroll.
