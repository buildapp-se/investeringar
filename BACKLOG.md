...
- [ ] **[P2] Läs villkoren för courtagefritt månadssparande i ETF hos Avanza och Nordnet.** Båda erbjuder någon form av automatiskt månadssparande i börshandlade fonder, och forumtrådar påstår att köpcourtaget då faller bort medan valutaväxlingen står kvar. Om det stämmer flyttar det brytpunkten påtagligt: courtaget är största posten i ett litet månadsköp. Sidan räknar i dag på en vanlig order och säger inget om månadssparavtal.
...
- [ ] **[P1] Kontrollera den ogiltiga ISIN-uppgiften `IE00034YBzg4` för AVWS mot Avantis prospekt.** Stod tidigare inbakad i Fondo-punkten.
...
- [ ] **[P2] Enkel vy kräver sidledsscroll på mobil.** Tabellen är 520 px bred vid 390 px skärm. Sidan i sig scrollar inte i sidled, tabellen scrollar i sin egen behållare, så det är inte trasigt men inte bra. Avgör om en av de tre kolumnerna ska falla bort på liten skärm när riktiga kolumnnamn och värden finns. **ETF-tabellen är värre:** 823 px med sex kolumner sedan köpvägarna och brytpunkten kom in. Samma behållarscroll, men avståndet till skärmbredden är större.
